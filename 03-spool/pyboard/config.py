...
# Trigger source for program 4: "thermal" or "pir"
TRIGGER_SOURCE = "thermal"

# MLX90640 thermal camera trigger settings
MLX_REFRESH_HZ = 32        # sensor frame rate: 1/2/4/8/16/32/64
MLX_BORDER     = 5        # edge pixels to ignore on each side
MLX_THRESHOLD  = 10.0     # mean abs-diff to declare motion
